...
CREATE TABLE `vehicles` (
  ...
  KEY `vehicles_users_FK` (`OWNER_ID`),
  CONSTRAINT `vehicles_cat_type_vehicle_FK` FOREIGN KEY (`TYPE_VEHICLE`) REFERENCES `cat_type_vehicle` (`ID`),
  CONSTRAINT `vehicles_users_FK` FOREIGN KEY (`OWNER_ID`) REFERENCES `users` (`ID`)
...
INSERT INTO `vehicles` VALUES (17,'RGX115',78,'HYUNDAI','negro','Tucson',2);
...
-- Dump completed on 2024-04-24 21:31:36
